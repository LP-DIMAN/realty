    ...
    */
    ...
    'custom' => [
        'surname' => [
            ...
            'min' => "Поле 'фамилия' должно быть не менее :min.",
            'max' => "Поле 'фамилия' должно быть не менее :max."
        ],
        'name' => [
            'required' => "Поле 'имя' обязательно для заполнения.",
            'min' => "Поле 'имя' должно быть не менее :min.",
            'max' => "Поле 'имя' должно быть не менее :max."
        ],
        'patronymic' => [
            'required' => "Поле 'отчество' обязательно для заполнения.",
            'min' => "Поле 'отчество' должно быть не менее :min.",
            'max' => "Поле 'отчество' должно быть не менее :max."
        ],
        'phone' => [
            'required' => "Поле 'телефон' обязательно для заполнения.",
            'min' => "Поле 'телефон' должно быть не менее :min.",
            'max' => "Поле 'телефон' должно быть не менее :max."
        ],
        'email' => [
            'required' => "Поле 'электронная почта' обязательно для заполнения.",
            'min' => "Поле 'электронная почта' должно быть не менее :min.",
            'max' => "Поле 'электронная почта' должно быть не менее :max.",
            'unique' => "Такое значение поля 'элетронная почта' уже существует."
        ],
        'password' => [
            'required' => "Поле 'пароль' обязательно для заполнения.",
            'min' => "Поле 'пароль' должно быть не менее :min.",
            'max' => "Поле 'пароль' должно быть не менее :max.",
            'confirmed' => "Поле 'пароль' не совпадает с подтверждением."
        ],
    ],
